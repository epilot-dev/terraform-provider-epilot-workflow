...
func (s *ClosingReason) CreateClosingReason(ctx context.Context, request shared.ClosingReason, opts ...operations.Option) (*operations.CreateClosingReasonResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
