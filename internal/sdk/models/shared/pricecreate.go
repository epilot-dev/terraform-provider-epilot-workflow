...
func (u *PriceCreateUnit) UnmarshalJSON(data []byte) error {
	...
	var priceCreate1 PriceCreate1 = PriceCreate1("")
	...
	return fmt.Errorf("could not unmarshal `%s` into any supported union types for PriceCreateUnit", string(data))
}
...
func (u PriceCreateUnit) MarshalJSON() ([]byte, error) {
	...
	return nil, errors.New("could not marshal union type PriceCreateUnit: all fields are null")
}
