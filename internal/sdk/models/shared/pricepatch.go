...
func (u *PricePatchUnit) UnmarshalJSON(data []byte) error {
	...
	var pricePatch1 PricePatch1 = PricePatch1("")
	...
	return fmt.Errorf("could not unmarshal `%s` into any supported union types for PricePatchUnit", string(data))
}
...
func (u PricePatchUnit) MarshalJSON() ([]byte, error) {
	...
	return nil, errors.New("could not marshal union type PricePatchUnit: all fields are null")
}
