...
func (u *Unit) UnmarshalJSON(data []byte) error {
	...
	return fmt.Errorf("could not unmarshal `%s` into any supported union types for Unit", string(data))
}
...
func (u Unit) MarshalJSON() ([]byte, error) {
	...
	return nil, errors.New("could not marshal union type Unit: all fields are null")
}
