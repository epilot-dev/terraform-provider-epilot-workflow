...
// Generated from OpenAPI doc version 1.1.0 and generator version 2.884.0
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.30.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 0.30.0 2.884.0 1.1.0 github.com/epilot-dev/terraform-provider-epilot-workflow/internal/sdk",
