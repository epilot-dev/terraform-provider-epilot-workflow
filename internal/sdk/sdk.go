...
// Generated from OpenAPI doc version 1.0.0 and generator version 2.632.1
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.18.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 0.18.0 2.632.1 1.0.0 github.com/epilot-dev/terraform-provider-epilot-workflow/internal/sdk",
